"""Gradient Boosting Regressor node for ML Pipeline."""
...
def gradient_boosting_regressor_node(state: PipelineState) -> PipelineState:
    """
    ...
    """
    node_name = "gradient_boosting_regressor"
